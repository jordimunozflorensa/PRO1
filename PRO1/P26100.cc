...
int adjacent_bacterias(const Matrix& a, const int x, const int y) {
	int rows, cols, c = 0;
	rows = a.size();
	cols = a[0].size();
...
void evaluate_cell(const Matrix& a, const int x, const int y, Matrix& b) {
